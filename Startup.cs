...
public class Startup
{
  ...
  public void ConfigureServices(IServiceCollection services)
  {
    ...
    // TODO ConfigureAuth(services);  comment this out until we bring in auth
    services.AddControllers();
    services.AddSwaggerGen(c =>
    {
      c.SwaggerDoc("v1", new OpenApiInfo { Title = "csTodo", Version = "v1" });
    });
    ...
    services.AddSingleton<FakeDB>(); //NOTE weirdness with just the fakeDB to stay persistent
